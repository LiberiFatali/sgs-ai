...
_ITEMS_TO_DESCRIPTIONS = {
    ...
    'label': 'The label id of the image, integer between 0 and 1016',
...
def create_readable_names_for_imagenet_labels():
  ...
  Returns:
      labels_to_names: dictionary where keys are integers from to 1017
      and values are human-readable names.

  We retrieve a synset file, which contains a list of valid synset labels used
  by SgsNet. There is one synset one per line, eg.
          #   n01440764
          #   n01443537
          #   ass
          #   penis
  ...
  # synset_file = '/home/hieunguyen/tf_workspace/models/inception/sgsnet-data/raw-data/sgsnet_1017_synsets.txt'
  # synset_list = [s.strip() for s in open(synset_file).readlines()]
  # num_synsets_in_sgsnet = len(synset_list)
  # assert num_synsets_in_sgsnet == 1017

  # #filename, _ = urllib.request.urlretrieve(synset_to_human_url)
  # meta_file = '/home/hieunguyen/tf_workspace/models/inception/sgsnet-data/raw-data/sgsnet_1017_metadata.txt'
  # synset_to_human_list = open(meta_file).readlines()
  # num_synsets_in_all_sgsimagenet = len(synset_to_human_list)
  # assert num_synsets_in_all_sgsimagenet == 21859
  ...
  labels_to_names = {0: 'background', 1: 'approve', 2: 'reject'}
